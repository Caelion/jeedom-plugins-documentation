...
- 27/03/2026 : Correctif pour PHP8 + Correction d'erreur d'appel API sur la liste_modules, last_indexes et last_currents + Ajout d'une colonne Etat dans la vue Equipement + Correctif sur erreur API